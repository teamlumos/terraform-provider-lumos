...
func setRequestablePermissionResourceModelFromLumosAPIRequestablePermission(ctx context.Context, permissionResource requestablePermissionResourceModel, lumosApiPermission lumosAPIAppStoreRequestablePermissionResponse) requestablePermissionResourceModel {
	...
	if lumosApiPermission.RequestConfig.RequestFulfillmentConfig.TimeBasedAccessOverride != nil {
		permissionResource.TimeBasedAccessOverride, _ = types.SetValueFrom(ctx, types.BoolType, lumosApiPermission.RequestConfig.RequestFulfillmentConfig.TimeBasedAccessOverride)
	}
