...
// Generated from OpenAPI doc version 0.1.0 and generator version 2.793.2
...
func New(opts ...SDKOption) *Lumos {
	sdk := &Lumos{
		SDKVersion: "0.10.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.10.6 2.793.2 0.1.0 github.com/teamlumos/terraform-provider-lumos/internal/sdk",
