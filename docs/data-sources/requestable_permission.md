...
- `include_inherited_configs` (Boolean) Include inherited configurations from parent app.
...
- `request_config` (Attributes) (see [below for nested schema](#nestedatt--request_config))
